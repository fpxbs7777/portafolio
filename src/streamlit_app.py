...
# --- FUNCIONES DE CLIENTES Y AUTENTICACIÓN ---
...
# --- FUNCIONES DE ANÁLISIS Y PÁGINAS ---
        ...
        try:
            ...
            return {
                ...
                "dolares_financieros": {
                    ...
                    "Canje": {"valor": "Sin datos IOL", "variacion": None}
                },
...
def main():
    ...
    # Barra lateral - Autenticación y selección de cliente
    with st.sidebar:
