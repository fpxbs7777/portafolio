...
# Configuración de la página - SOLO UNA VEZ al inicio
try:
    st.set_page_config(
    ...
    # Si ya está configurado, continuar silenciosamente
    pass
...
def main():
    ...
    """
    # NO configurar página aquí - ya se hizo al inicio del archivo
