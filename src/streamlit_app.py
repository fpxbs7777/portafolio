...
def mostrar_movimientos_asesor():
    ...
    with st.form("form_buscar_movimientos"):
        ...
        col1, col2 = st.columns(2)
        with col1:
            fecha_desde = st.date_input("Fecha desde", value=date.today() - timedelta(days=30), key="fecha_desde_movimientos")
        with col2:
            fecha_hasta = st.date_input("Fecha hasta", value=date.today(), key="fecha_hasta_movimientos")
